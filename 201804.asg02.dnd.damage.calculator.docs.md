...
What is the character's class  [(C)leric, (F)ighter, (R)ogue, (W)izard ]? w
What is the character's level [ 1-20 ]? 4
What is the character's strength [ 3-18 ]? 3
What is the character's dexterity [ 3-18 ]? 18


Here is the table for a 4th level Wizard (prof +2) with 3 STR(-4) and 18 DEX(+4):

Weapon     | Attack Roll Bonus | Damage (Type) | Notes
-----------+-------------------+---------------+----------
Dagger     | +6                | 5-8 (P)       | Simple*
Sickle     | -4                | - (S)         | Simple
...
- the damage display for Sickle
- the two finesse weapons (Dagger and Rapier) show that you can take part in melee
even with a poor strength
